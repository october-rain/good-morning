...
class Profile(models.Model):
    ...
    headimg = models.CharField(
        max_length=200, default='https://api.tian999.top/upload/headDefaultImg.jpeg')
...
class Tag(models.Model):
    ...
    article = models.ManyToManyField(
        to='Article', through='Tag_Article', through_fields=('tagID', 'article_id'))
...
class Mood(models.Model):
    ...
    createtime = models.DateField(blank=True, null=True)
    belong = models.ForeignKey(
        Userinfo, on_delete=models.CASCADE, null=True, blank=True, related_name='mood_user')
    def __str__(self):
        return self.moodname